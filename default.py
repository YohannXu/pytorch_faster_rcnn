...
cfg.PRUNE = edict()
cfg.PRUNE.BASE_LR = 0.0025
cfg.PRUNE.WEIGHT_DECAY = 0.0001
cfg.PRUNE.BIAS_LR = 2
cfg.PRUNE.BIAS_WEIGHT_DECAY = 0
cfg.PRUNE.MOMENTUM = 0.9
cfg.PRUNE.NUM_ITERS = 80000
cfg.PRUNE.RATIO = 0.1
cfg.PRUNE.STEPS = (10000, 30000, 70000)
cfg.PRUNE.GAMMA = 0.1
cfg.PRUNE.WARMUP_FACTOR = 1.0 / 3
cfg.PRUNE.WARMUP_ITERS = 500
cfg.PRUNE.WARMUP_METHOD = 'linear'
